...
(test (free-ids (parse '(with (a a) a))) (list 'a)) ;; a free in named expr same name as name being bound, bound body expr
...
(test (free-ids (parse '(with (a (with (b (add c d)) b)) a))) (list 'c 'd)) ;; c and d free in named expr of inner with expr
...
(test (bound-ids (parse '(with (a 7) b))) (list 'a)) ;; b free in body expr
(test (bound-ids (parse '(with (a b) a))) (list 'a)) ;; b free in named expr
(test (bound-ids (parse '(with (a b) b))) (list 'a)) ;; b free in named expr and body expr
(test (bound-ids (parse '(with (a a) 7))) (list 'a)) ;; a free in named expr, same name as name being bound
(test (bound-ids (parse '(with (a a) a))) (list 'a)) ;; a free in named expr same name as name being bound, bound body expr

;; nested with tests
(test (bound-ids (parse '(with (a (with (b 7) 8)) a))) (list 'a 'b)) ;; nested with expr, no free ids
(test (bound-ids (parse '(with (a (with (b 7) a)) a))) (list 'a 'b)) ;; a free in body of inner with expr
(test (bound-ids (parse '(with (a (with (b (add c d)) b)) a))) (list 'a 'b)) ;; c and d free in named expr of inner with expr
(test (bound-ids (parse '(with (a (with (b (add c d)) b)) (with (z a) (add z z))))) (list 'a 'b 'z))
(test (bound-ids (parse '(with (z (with (a (add c d)) b)) (with (b a) (add z z))))) (list 'a 'b 'z))
(test (bound-ids (parse '(with (z (with (z (add c d)) b)) (with (z a) (add z z))))) (list 'z))
;;;;;;;;;;add a few more tests here ppppppppppppppppppppppppppppppppppppppppppp
