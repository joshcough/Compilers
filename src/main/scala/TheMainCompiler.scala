...
object TheMainCompiler extends Timer {
  ...
  def compileToStrings(code:String): (String, String, String, String) = {
    ...
    timed("Complete compilation: ", {
      val l4 = timed("L5 Compiler", l5c.compile(code))
      //    println("l4: " + L4Printer.toCode(l4))
      val l3 = timed("L4 Compiler", l4c.compile(l4))
      //    println("l3: " + l3)
      val l2 = timed("L3 Compiler", l3c.compile(l3))
      //    println("l2: " + L2Printer.toCode(l2))
      val l1String = timed("L2 Compiler", L2Printer.toCode(l2c.compile(l2)))
      //    println("l1: " + l1String)
