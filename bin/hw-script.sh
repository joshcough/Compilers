...
rm -rf .git project target out lib_managed 444-code src/main/scheme Test.class Test.j compilers.iml runtime.o test.S test2.S a.out bin Test.o Test.S
# just for now:
...
echo "done. now run:"
echo "scp ./compilers-hw1.tar.gz jdc974@tlab-18.cs.northwestern.edu:./spring2011/"
